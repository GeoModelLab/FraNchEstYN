...
kable(
  management_indiana %>%
    ...
    slice_head(n = 3),
  caption = "management_indiana — management metadata (first 6 rows)"
)
```
...
🌎 Explore other environments: replace weather_indiana, reference_indiana, and management_indiana with datasets from different sites or years.
